...
void state_forward() {
    ...
    // Go forward
    khepera4_drive_set_speed_differential(algorithm.configuration.speed, 1., 0.);
    ...
    while (1) {
        ...
        if ((khepera4.infrared_proximity.sensor[cKhepera4SensorsInfrared_FrontLeft] > algorithm.configuration.wall_threshold) || (khepera4.infrared_proximity.sensor[cKhepera4SensorsInfrared_FrontRight] > algorithm.configuration.wall_threshold)) {
        ...
        if (algorithm.configuration.verbosity > 1) {
            ...
            printf(",%d", khepera4.infrared_proximity.sensor[cKhepera4SensorsInfrared_FrontLeft]);
            printf(",%d", khepera4.infrared_proximity.sensor[cKhepera4SensorsInfrared_FrontRight]);
            printf("\n");
        }
...
void state_turn() {
    ...
    // Turn slowly
    khepera4_drive_set_speed_differential(algorithm.configuration.speed, 0., 0.5);
