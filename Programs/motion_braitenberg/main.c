...
void braitenberg_set_obstacle_avoidance(struct sBraitenberg *braitenberg, int aggressivity) {
	braitenberg->weight_left[cKhepera3SensorsInfrared_BackLeft] = -1 * aggressivity;
	braitenberg->weight_left[cKhepera3SensorsInfrared_Left] = 1 * aggressivity;
	braitenberg->weight_left[cKhepera3SensorsInfrared_FrontLeft] = 3 * aggressivity;
	braitenberg->weight_left[cKhepera3SensorsInfrared_Front] = 0;
	braitenberg->weight_left[cKhepera3SensorsInfrared_FrontRight] = -3 * aggressivity;
	braitenberg->weight_left[cKhepera3SensorsInfrared_Right] = -1 * aggressivity;
	braitenberg->weight_left[cKhepera3SensorsInfrared_BackRight] = 1 * aggressivity;
	braitenberg->weight_left[cKhepera3SensorsInfrared_Back] = 0;
	braitenberg->weight_left[cKhepera3SensorsInfrared_FloorLeft] = 0;
	braitenberg->weight_left[cKhepera3SensorsInfrared_FloorFrontLeft] = 0;
	braitenberg->weight_left[cKhepera3SensorsInfrared_FloorFrontRight] = 0;
...
void braitenberg_set_wall_following_left(struct sBraitenberg *braitenberg) {
	...
	braitenberg->bias[cKhepera3SensorsInfrared_BackLeft] = 0;
	braitenberg->bias[cKhepera3SensorsInfrared_Left] = -1500;
	braitenberg->bias[cKhepera3SensorsInfrared_FrontLeft] = 0;
}

void braitenberg_set_wall_following_right(struct sBraitenberg *braitenberg) {
	braitenberg_set_obstacle_avoidance(braitenberg, 5);
	braitenberg->bias[cKhepera3SensorsInfrared_BackRight] = 0;
	braitenberg->bias[cKhepera3SensorsInfrared_Right] = -1500;
	braitenberg->bias[cKhepera3SensorsInfrared_FrontRight] = 0;
}
...
void braitenberg_set_line_following_white(struct sBraitenberg *braitenberg) {
	braitenberg_set_obstacle_avoidance(braitenberg, 5);
	braitenberg->weight_left[cKhepera3SensorsInfrared_FloorFrontLeft] = -10;
	braitenberg->weight_left[cKhepera3SensorsInfrared_FloorFrontRight] = 10;
	braitenberg->weight_right[cKhepera3SensorsInfrared_FloorFrontLeft] = 10;
	braitenberg->weight_right[cKhepera3SensorsInfrared_FloorFrontRight] = -10;
}
...
void braitenberg_run(struct sBraitenberg *braitenberg) {
	...
	while (1) {
		...
		if (verbosity > 1) {
			...
			printf(",%d\n", (unsigned int) khepera3.infrared_proximity.timestamp);
		}
		if (verbosity > 1) {
