...
void operation_calibrate() {
	...
	for (a = 0; a < 64; a++) {
		...
		// Move the robot
		khepera3_drive_goto_position(-(int)floor(a*conversion + 0.5), (int)floor(a*conversion + 0.5));
		usleep(1000000);
...
void operation_turn() {
	...
	khepera3_drive_goto_position((int)floor(64*conversion + 0.5), -(int)floor(64*conversion + 0.5));
}
