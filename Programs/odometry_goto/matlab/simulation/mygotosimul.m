...
for i=1:1000
	...
	speedfactor=dist*11;
	if speedfactor>2, speedfactor=2; end
	...
	if delta1>prevdelta1, delta1=prevdelta1+1; end
	if delta1<prevdelta1, delta1=prevdelta1-1; end
	if delta2>prevdelta2, delta2=prevdelta2+1; end
	if delta2<prevdelta2, delta2=prevdelta2-1; end
	prevdelta1=delta1;
	prevdelta2=delta2;
	if abs(delta1)<10, delta1=0; end
	if abs(delta2)<10, delta2=0; end
	logdelta1(i)=delta1;
	logdelta2(i)=delta2;
