#ifndef KHEPERA3_DRIVE_H
#define KHEPERA3_DRIVE_H
...
//! Sets each motor speed and saves that current speed in khepera3 motor structure
void khepera3_drive_set_speed(int speed_left, int speed_right);
//! Sets differential by executing khepera3_drive_set_speed(int speed_left, int speed_right)
void khepera3_drive_set_speed_differential(float speed, float forward_coefficient, float differential_coefficient);
//! Sets differential bounded speed by executing khepera3_drive_set_speed(int speed_left, int speed_right)
...
//! Sets encoders position and saves that current position in khepera3 motor structure
void khepera3_drive_set_current_position(int position_left, int position_right);
//! Does nothing as last speed set is always saved in khepera3 motor structure
